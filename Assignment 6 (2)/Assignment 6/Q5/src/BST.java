...
//5. Print parent of user entered node in BST
...
public class BST {
	...
	public void parentOfGivenNode(int key) {
		Node trav = root;
		Node parent = null;
		if(key==root.data) {
			System.out.println("Parent of " + key + ": null");
			return;
		}
		while(trav!=null) {
			if(key == trav.data) {
				System.out.println("Parent of " + key + ": " + parent.data);
				break;
			}
			parent = trav;
			if(key<trav.data)
